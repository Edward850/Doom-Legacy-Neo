...
//-----------------------------------------------------------------------------
//
// $Id: dehacked.c,v 1.16 2003/11/21 17:52:05 darkwolf95 Exp $
//
...
extern bool infight; //DarkWolf95:November 21, 2003: Monsters Infight!
...
static void readthing(MYFILE *f,int num)
{
  ...
  do{
    if(myfgets(s,sizeof(s),f)!=NULL)
    {
      ...
      else if(!strcmp(word,"Hit"))          mobjinfo[num].spawnhealth = (statenum_t)value;
...
static void readweapon(MYFILE *f,int num)
{
  ...
  do{
    if(myfgets(s,sizeof(s),f)!=NULL)
    {
      ...
      else if(!strcmp(word,"Shooting"))   doomweaponinfo[num].atkstate  = doomweaponinfo[num].holdatkstate = (statenum_t)value;
...
// [Edward] 8/22/2026: I think this feature came from a good place but nowadays it's kind of pointless.
#if 0
