...
//-----------------------------------------------------------------------------
//
// $Id: hw_bsp.c,v 1.21 2002/07/20 03:41:21 mrousseau Exp $
//
...
static bool NearVertice (polyvertex_t* p1, polyvertex_t* p2)
{
#if 1
    float diff;
    diff = p2->x - p1->x;
...
static bool SameVertice (polyvertex_t* p1, polyvertex_t* p2)
{
#if 0
    float diff;
    diff = p2->x - p1->x;
...
//#define MOVEVERTEX
bool PointInSeg(polyvertex_t* a,polyvertex_t* v1,polyvertex_t* v2)
{
