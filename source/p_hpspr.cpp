...
extern bool P_GiveBody(player_t* player, int num);
...
void A_SkullRodStorm(mobj_t *actor)
{
        ...
        mo = P_SpawnMobj(x, y, ONCEILINGZ, (mobjtype_t)(MT_RAINPLR1+actor->special2));
...
void A_RainImpact(mobj_t *actor)
{
        ...
        {
                P_SetMobjState(actor, (statenum_t)(S_RAINAIRXPLR1_1+actor->special2));
        }
        else if(P_Random() < 40)
        {
                P_HitFloor(actor);
