...
bool PIT_NodeReachable (line_t* ld)
{
...
bool B_CheckNodePosition(mobj_t* thing, fixed_t x, fixed_t y)
{
    int                 xl;
    int                 xh;
    int                 yl;
...
{
	SearchNode_t* newnode = (SearchNode_t*)Z_Malloc(sizeof(SearchNode_t), PU_LEVEL, 0);
