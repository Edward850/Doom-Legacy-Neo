...
//-----------------------------------------------------------------------------
//
// $Id: m_misc.c,v 1.10 2004/04/18 12:40:14 hurdler Exp $
//
                    ...
                    byte*         palette )
{
    ...
    pcx->xmin = 0;
    pcx->ymin = 0;
    pcx->xmax = LE_SWAP_SHORT(width-1);
    pcx->ymax = LE_SWAP_SHORT(height-1);
    pcx->hres = LE_SWAP_SHORT(width);
    pcx->vres = LE_SWAP_SHORT(height);
    memset (pcx->palette,0,sizeof(pcx->palette));
    pcx->color_planes = 1;              // chunky image
    pcx->bytes_per_line = LE_SWAP_SHORT(width);
    pcx->palette_type = LE_SWAP_SHORT(1);       // not a grey scale
