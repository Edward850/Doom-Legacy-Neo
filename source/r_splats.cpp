...
//-----------------------------------------------------------------------------
//
// $Id: r_splats.c,v 1.6 2002/09/12 20:10:50 hurdler Exp $
//
...
#endif
            for(p_splat = (wallsplat_t *)li->splats;p_splat->next;p_splat = p_splat->next)
...
*/
    ...
    if (wallline->splats)
    {
        p_splat = (wallsplat_t *)wallline->splats;
        while (p_splat->next)
