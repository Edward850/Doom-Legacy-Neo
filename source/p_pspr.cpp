...
//-----------------------------------------------------------------------------
//
// $Id: p_pspr.c,v 1.11 2003/01/19 21:24:26 bock Exp $
//
...
void A_TicWeapon(player_t*     player,
                 pspdef_t*     psp )
{
    if( (void*)psp->state->action.acp2 == (actionf_p2)A_WeaponReady && psp->tics == psp->state->tics )
    {
        int         angle;
                    ...
                    pspdef_t*     psp )
{
    ...
    P_SetPsprite (player,
                  ps_flash,
                  (statenum_t)(player->weaponinfo[player->readyweapon].flashstate+(P_Random ()&1)) );
                  ...
                  pspdef_t*     psp )
{
    ...
    P_SetPsprite (player,
                  ps_flash,
                  (statenum_t)(player->weaponinfo[player->readyweapon].flashstate
                      + psp->state
                      - &states[S_CHAIN1]) );
