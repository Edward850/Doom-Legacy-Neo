...
//-----------------------------------------------------------------------------
//
// $Id: i_system.c,v 1.12 2003/05/04 04:24:08 sburke Exp $
//
...
void I_GetDiskFreeSpace(long long *freespace) {
    ...
    *freespace = stfs.f_bavail*stfs.f_bsize;
    ...
    ULARGE_INTEGER pTotal;
    GetDiskFreeSpaceExA(NULL, &pFreeBytesAvailable, &pTotal, NULL);
	*freespace = pFreeBytesAvailable.QuadPart;
#endif
